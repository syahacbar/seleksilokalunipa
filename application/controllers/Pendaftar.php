...
class Pendaftar extends MY_Controller {
    ...
    public function ajax_add()
    {
        ...
        if ($this->input->post('nnumerik') == '') {
            $res['error']['nnumerik'] = '* Wajib Diisi';
        } 
        if ($this->input->post('ninggris') == '') {
            $res['error']['ninggris'] = '* Wajib Diisi';
        } 
        if ($this->input->post('nfigural') == '') {
            $res['error']['nfigural'] = '* Wajib Diisi';
        } 
        ...
        if (empty($res['error'])) {
            ...
            $data = array(
                ...
                'nnumerik' => $this->input->post('nnumerik'),
                'ninggris' => $this->input->post('ninggris'),
                'nfigural' => $this->input->post('nfigural'),
            ...
            for ($row = 2; $row <= $highestRow; $row++){                  //  Read a row of data into an array                 
                $rowData = $sheet->rangeToArray('A' . $row . ':' .$maxCell['column'] . $maxCell['row'],
                 ...
                 $data = array(
                    ...
                    "nverbal"=> $rowData[0][13],
                    "nnumerik"=> $rowData[0][14],
                    "ninggris"=> $rowData[0][15],
                    "nfigural"=> $rowData[0][16],
                    "status"=> "B",
