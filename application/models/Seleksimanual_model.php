...
class Seleksimanual_model extends CI_Model {
    ...
    var $table = 'v_seleksi';
    var $column_order = array('','nopendaftar','namapendaftar','','suku','jurusanslta','nverbal','nnumerik','ninggris','nfigural','ratarata','tahunlulus','status'); //set column field database for datatable orderable
