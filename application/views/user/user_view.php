  ...
  <div class="box">
   <div class="box-header">
     ...
     <div class="pull-right">
        <button class="btn btn-sm btn-danger" onclick="reset_all_password()"><i class="glyphicon glyphicon-refresh"></i> Reset Password Semua User</button>
...
function reset_login(id){
        $.ajax({
            url : "<?php echo site_url('user/reset_login')?>/"+ id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
