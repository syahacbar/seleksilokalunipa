      ...
      <div class="row">
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo $kuotapenerimaan;?></h3>
            ...
            <a href="<?php echo site_url('prodi'); ?>" class="small-box-footer">Info Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
       <!-- ./col -->
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="<?php echo site_url('pendaftar'); ?>" class="small-box-footer">Info Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="<?php echo site_url('penerimaan'); ?>" class="small-box-footer">Info Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
