...
function terima(id){
    ...
    if(prodi == '0' || prodi == 'x'){
        ...
        $.ajax({
            url : "<?php echo site_url('seleksimanual/terima')?>/"+ id,
            type: "POST",
            dataType: "JSON",
                ...
                <form action="#" id="form" class="form-horizontal" style="font-size:12px">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input name="nnumerik" readonly="readonly" class="form-control" type="number">
                                <span class="text-danger" id="error_nnumerik"></span>
                            </div>
                            <div class="col-md-3">
                                <input name="ninggris" readonly="readonly" class="form-control" type="number">
                                <span class="text-danger" id="error_ninggris"></span>
                            </div>
                            <div class="col-md-3">
                                <input name="nfigural" readonly="readonly" class="form-control" type="number">
