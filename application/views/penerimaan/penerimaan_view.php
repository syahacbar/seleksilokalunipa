  ...
  <div class="box">
   <div class="box-header">
     ...
     <?php if($this->ion_auth->is_admin()){?>
        ...
        <a target="blank" class="btn btn-sm btn-success" href="<?=site_url('laporan/laporanexcel')?>"><i class="fa fa-file-excel-o"></i> Export Excel</a>
        <a target="blank" class="btn btn-sm btn-primary" href="<?=site_url('laporan/pdfsk')?>"><i class="fa fa-file-pdf-o"></i> Cetak SK</a>
        <a target="blank" class="btn btn-sm btn-warning" href="<?=site_url('laporan/pdfcetak')?>"><i class="fa fa-file-pdf-o"></i> Cetak Hasil</a>
     <?php } ?>
...
function batalkan(id){
    var status = 'B';
    $.ajax({
        url : "<?php echo site_url('penerimaan/batalkan')?>/"+ id,
        type: "POST",
        dataType: "JSON",
        data: {'status':status},
...
function batalkansemua(){
    if(confirm('Apakah anda yakin akan membatalkan semua peserta yang diterima?'))
    {
        var status = 'B';
        $.ajax({
            url : "<?php echo site_url('penerimaan/batalkansemua')?>",
            type: "POST",
            dataType: "JSON",
            data: {'status':status},
            success: function(data)
