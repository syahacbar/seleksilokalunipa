...
function savesesipilihan(){
    ...
    $.ajax({
        url : "<?php echo site_url('pengaturan/simpansesipilihan')?>",
        type: "POST",
        dataType: "JSON",
...
function savetahunakademik(){
    ...
    $.ajax({
        url : "<?php echo site_url('pengaturan/simpantahunakademik')?>",
        type: "POST",
        dataType: "JSON",
...
function savenamarektor(){
    ...
    $.ajax({
        url : "<?php echo site_url('pengaturan/simpannamarektor')?>",
        type: "POST",
        dataType: "JSON",
...
function saveniprektor(){
    ...
    $.ajax({
        url : "<?php echo site_url('pengaturan/simpanniprektor')?>",
        type: "POST",
        dataType: "JSON",
...
function savestatususer(){
    ...
    $.ajax({
        url : "<?php echo site_url('pengaturan/simpanstatususer')?>",
        type: "POST",
        dataType: "JSON",
...
function savelampiransk(){
    ...
    $.ajax({
        url : "<?php echo site_url('pengaturan/simpanlampiransk')?>",
        type: "POST",
        dataType: "JSON",
...
function savenomorsk(){
    ...
    $.ajax({
        url : "<?php echo site_url('pengaturan/simpannomorsk')?>",
        type: "POST",
        dataType: "JSON",
...
function savetentangsk(){
    ...
    $.ajax({
        url : "<?php echo site_url('pengaturan/simpantentangsk')?>",
        type: "POST",
        dataType: "JSON",
